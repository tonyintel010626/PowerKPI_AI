# NVU Platform — Windows-Specific Notes
...
This file will contain **Windows-specific** details for NVU platform integration and configuration.
...
- Parent: [fv-nvu/platform](SKILL.md)
