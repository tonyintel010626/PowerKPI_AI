    ...
    return [
      ...
      },
      {
        ...
        onSelect: async (dialog) => {
          ...
          await Clipboard.copy(store.prompt.input)
          toast.show({
          ...
          >
            <textarea
              ...
              onKeyDown={async (e) => {
                ...
                // Check clipboard for images/text before terminal-handled paste runs.
                ...
                if (keybind.match("input_paste", e)) {
                  ...
                  // If nothing in clipboard, let the default paste behavior continue
                }
                // Ctrl+C: copy current chatbox content to clipboard
            ...
            <box gap={2} flexDirection="row">
              ...
              <Switch>
                <Match when={store.mode === "normal"}>
                  ...
                  <Show when={!!store.prompt.input}>
                    <text fg={theme.text}>
                      ctrl+c <span style={{ fg: theme.textMuted }}>copy prompt</span>
                    </text>
                  </Show>
                  <text fg={theme.text}>
