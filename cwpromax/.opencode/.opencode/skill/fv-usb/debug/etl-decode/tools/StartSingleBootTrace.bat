...
rem This batch file will overwrite the log on every reboot.
...
set TRACE_DIR="TBT_SINGLE_BOOT_LOG_%mydate%_%mytime%%SUFFIX%"
...
rem logman create trace autosession\TbtBootLogSession -o %TRACE_DIR%\TbtLog.etl -ets -pf wpp.guids
logman create trace autosession\TbtBootLogSession -o %TRACE_DIR%\TbtLog.etl -nb 16 256 -bs 1000 -ets -pf wpp.guids
